...
import {addAgendaItens, getAgenda, getMinhasAgendas, atualizarAgendaPago, getTodasAgendas, atualizarAgendaConfirmado, atualizarAgendaData, atualizarAgendaRecusado} from '../controllers/agendaController.js'
...
router.route('/:id/recusado').put(protect, admin, atualizarAgendaRecusado)
